...
```bash
node tools/selftest.mjs       # 379 checks: parsing, PDF extraction, citations, tree, share links, live eCFR, local data
npm i -D linkedom             # once, for the DOM tests
node tools/rendertest.mjs     # 210 checks: both panes, the redline, additions, resolvers, fallback states, wiring
